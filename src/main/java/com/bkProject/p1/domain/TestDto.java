...
public class TestDto {
    ...
    public TestDto(){}
    public TestDto(String title, String main_content, String detail_content, String start_time, String end_time, String area_info, String hourly_cost, String[] category) {
        this.title = title;
